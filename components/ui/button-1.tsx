  ...
  'cursor-pointer group whitespace-nowrap focus-visible:outline-hidden inline-flex items-center justify-center has-data-[arrow=true]:justify-between whitespace-nowrap text-sm font-medium ring-offset-background transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-60 [&_svg]:shrink-0',
  {
    variants: {
      ...
      size: {
        ...
        md: 'h-[2.125rem] rounded-md px-3 gap-1.5 text-[0.8125rem] [&_svg:not([class*=size-])]:size-4',
        sm: 'h-7 rounded-md px-2.5 gap-1.25 text-xs [&_svg:not([class*=size-])]:size-3.5',
        icon: 'size-[2.125rem] rounded-md [&_svg:not([class*=size-])]:size-4 shrink-0',
      },
      autoHeight: {
        true: '',
        false: '',
    ...
    compoundVariants: [
      ...
      // Auto height
      {
        size: 'md',
        autoHeight: true,
        className: 'h-auto min-h-[2.125rem]',
      },
      {
        size: 'sm',
        autoHeight: true,
      ...
      },
      {
        size: 'md',
        mode: 'icon',
        className: 'w-[2.125rem] h-[2.125rem] p-0 [&_svg:not([class*=size-])]:size-4',
      },
      {
        size: 'icon',
        className: 'w-[2.125rem] h-[2.125rem] p-0 [&_svg:not([class*=size-])]:size-4',
