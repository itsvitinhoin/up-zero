...
export default function Loading() {
  return (
    <div className="space-y-6 p-6 lg:p-8">
      ...
      <div className="rounded-2xl border border-border/40 bg-card p-4 shadow-sm">
        <div className="flex flex-col gap-3 xl:flex-row xl:items-center">
          ...
          <div className="flex w-full items-center gap-2 xl:w-auto">
            <Skeleton className="h-10 flex-1 rounded-full xl:w-60" />
            <Skeleton className="h-10 flex-1 rounded-full xl:w-45" />
            <Skeleton className="h-10 flex-1 rounded-full xl:w-40" />
      ...
      <div className="overflow-hidden rounded-2xl border border-border/40 bg-card shadow-sm md:hidden">
