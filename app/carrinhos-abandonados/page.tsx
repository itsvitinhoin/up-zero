...
export default function AbandonedCartsPage({ searchParams }: AbandonedCartsPageProps) {
  return (
    <Suspense fallback={<AdminRouteSkeleton />}>
      <AbandonedCartsPageContent searchParams={searchParams} />
    </Suspense>
  );
}

async function AbandonedCartsPageContent({ searchParams }: AbandonedCartsPageProps) {
  await connection();
